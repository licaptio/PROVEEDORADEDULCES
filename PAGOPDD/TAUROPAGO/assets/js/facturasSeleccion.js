...
import { recalcular, actualizarResumenSeleccionBruto } from './revisionEnlaces.js';
...
export async function cargarFacturas(){
  ...
  body.querySelectorAll('input[type=checkbox]').forEach(cb=>cb.addEventListener('change',()=>{actualizarResumenSeleccionBruto();recalcular()}));
  actualizarResumenSeleccionBruto();
}
